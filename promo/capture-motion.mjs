// Record the promo3.html canvas animation (35s) to motion-raw.webm.
import puppeteer from 'puppeteer-core';
import fs from 'node:fs';

const CHROME = '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome';
const HTML = new URL('./promo3.html', import.meta.url).href;
const OUT = new URL('./motion-raw.webm', import.meta.url).pathname;
