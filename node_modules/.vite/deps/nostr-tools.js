...
function mergeReverseSortedLists(list1, list2) {
  ...
  while (i1 < list1.length && i2 < list2.length) {
    let next;
    if (((_a = list1[i1]) == null ? void 0 : _a.created_at) > ((_b = list2[i2]) == null ? void 0 : _b.created_at)) {
      next = list1[i1];
      i1++;
    } else {
      next = list2[i2];
...
var AbstractRelay = class {
  ...
  async connect(opts) {
    ...
    this.connectionPromise = new Promise((resolve, reject) => {
      ...
      if (opts == null ? void 0 : opts.abort) {
  ...
  async pingpong() {
    ...
    if (((_a = this.ws) == null ? void 0 : _a.readyState) === 1) {
      ...
      if (!result) {
        if (((_b = this.ws) == null ? void 0 : _b.readyState) === this._WebSocket.OPEN) {
      ...
      switch (data[0]) {
        case "EVENT": {
          ...
          if (this.verifyEvent(event) && matchFilters(so.filters, event)) {
            ...
            (_c = so.oninvalidevent) == null ? void 0 : _c.call(so, event);
          }
        ...
        default: {
          const so = this.openSubs.get(data[1]);
          (_d = so == null ? void 0 : so.oncustom) == null ? void 0 : _d.call(so, data);
          return;
        }
      }
    } catch (err) {
...
var AbstractSimplePool = class {
  ...
  async ensureRelay(url, params) {
    ...
    try {
      await relay.connect({
        timeout: params == null ? void 0 : params.connectionTimeout,
        abort: params == null ? void 0 : params.abort
      });
    } catch (err) {
      this.relays.delete(url);
      throw err;
  ...
  subscribeMap(requests, params) {
    ...
    const allOpened = Promise.all(
      groupedRequests.map(async ({ url, filters }, i2) => {
        var _a, _b, _c;
        if (((_a = this.allowConnectingToRelay) == null ? void 0 : _a.call(this, url, ["read", filters])) === false) {
        ...
        try {
          ...
          (_b = this.onRelayConnectionFailure) == null ? void 0 : _b.call(this, url);
          handleClose(i2, (err == null ? void 0 : err.message) || String(err));
          return;
        }
        (_c = this.onRelayConnectionSuccess) == null ? void 0 : _c.call(this, url);
    ...
    subcloser = this.subscribe(relays, filter, {
      ...
      oneose() {
        ...
        if (subcloser)
          ...
          (_a = params.onclose) == null ? void 0 : _a.call(params, relays.map((_) => reason));
      }
    });
    return subcloser;
  }
  ...
  publish(relays, event, params) {
    return relays.map(normalizeURL).map(async (url, i2, arr) => {
      ...
      if (((_a = this.allowConnectingToRelay) == null ? void 0 : _a.call(this, url, ["write", event])) === false) {
        return Promise.reject("connection skipped by allowConnectingToRelay");
      }
      let r;
      try {
        r = await this.ensureRelay(url, {
          connectionTimeout: this.maxWaitForConnection < ((params == null ? void 0 : params.maxWait) || 0) ? Math.max(params.maxWait * 0.8, params.maxWait - 1e3) : this.maxWaitForConnection,
          abort: params == null ? void 0 : params.abort
        });
      } catch (err) {
        (_b = this.onRelayConnectionFailure) == null ? void 0 : _b.call(this, url);
      ...
      return r.publish(event).catch(async (err) => {
        if (err instanceof Error && err.message.startsWith("auth-required: ") && (params == null ? void 0 : params.onauth)) {
      ...
      switch (data[0]) {
        case "NEG-MSG": {
          ...
          try {
            ...
            (_b = params == null ? void 0 : params.onclose) == null ? void 0 : _b.call(params, `reconcile error: ${error}`);
          }
          break;
        }
        case "NEG-CLOSE": {
          ...
          (_c = params.onclose) == null ? void 0 : _c.call(params, reason);
          break;
        }
        case "NEG-ERR": {
          (_d = params.onclose) == null ? void 0 : _d.call(params);
        }
      }
    };
  }
