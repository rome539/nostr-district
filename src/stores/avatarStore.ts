...
export interface AvatarConfig {
  ...
  hairColor: string;
  top: 'tshirt' | 'hoodie' | 'jacket' | 'tank' | 'dress' | 'vest' | 'trenchcoat' | 'croptop' | 'jersey' | 'longsleeve' | 'polo' | 'flannel' | 'bomber' | 'turtleneck' | 'robe' | 'bitcoinshirt' | 'ostrichshirt' | 'camoshirt' | 'camolongsleeve' | 'tunic' | 'skindress' | 'knightchest' | 'pizzashirt' | 'vjacket' | 'travelercoat' | 'twotoneshirt' | 'bannercoat' | 'twotonelongsleeve';
  topColor: string;
...
export const AVATAR_OPTIONS = {
  ...
  // 'ostrichhat' and 'crown_purple' are intentionally absent: set rewards
