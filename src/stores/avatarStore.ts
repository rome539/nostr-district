...
export interface AvatarConfig {
  ...
  hairColor: string;
  top: 'tshirt' | 'hoodie' | 'jacket' | 'tank' | 'dress' | 'vest' | 'trenchcoat' | 'croptop' | 'jersey' | 'longsleeve' | 'polo' | 'flannel' | 'bomber' | 'turtleneck' | 'robe' | 'bitcoinshirt' | 'ostrichshirt' | 'camoshirt' | 'camolongsleeve' | 'tunic' | 'skindress' | 'knightchest' | 'pizzashirt' | 'vjacket' | 'travelercoat' | 'twotoneshirt' | 'bannercoat';
  topColor: string;
...
export const AVATAR_OPTIONS = {
  ...
  top: ['tshirt', 'bitcoinshirt', 'ostrichshirt', 'camoshirt', 'camolongsleeve', 'vjacket', 'travelercoat', 'twotoneshirt', 'bannercoat', 'tunic', 'pizzashirt', 'polo', 'turtleneck', 'vest', 'tank', 'croptop', 'jersey', 'longsleeve', 'flannel', 'hoodie', 'bomber', 'jacket', 'dress', 'trenchcoat', 'robe', 'skindress'] as const,
