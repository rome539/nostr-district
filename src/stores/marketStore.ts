...
export const CATALOG: MarketItem[] = [
  ...
  { id: 'wall_marbleblack', name: 'Black Marble Wall', slot: 'wallTheme', value: 'marblewallblack', price: 1.50, tier: 'premium' },
  ...
  { id: 'floor_marbleblack', name: 'Black Marble Floor', slot: 'floorStyle', value: 'marbleblack', price: 1.50, tier: 'premium' },
