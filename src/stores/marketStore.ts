...
export const CATALOG: MarketItem[] = [
  ...
  { id: 'anim_jitter',     name: 'Jitter',           slot: 'nameAnim',  value: 'jitter',   price: 2.00, tier: 'accessories' },
  { id: 'anim_swing',      name: 'Swing',            slot: 'nameAnim',  value: 'swing',    price: 2.00, tier: 'accessories' },
