...
export const CATALOG: MarketItem[] = [
  ...
  { id: 'top_twotonelongsleeve', name: 'Two Tone Long Sleeve', slot: 'top', value: 'twotonelongsleeve', price: 1.50, tier: 'premium' },
  ...
  { id: 'bot_splitlinepants', name: 'Two Tone Pants',  slot: 'bottom',  value: 'splitlinepants', price: 1.50, tier: 'premium' },
  { id: 'bot_carnivalpants',  name: 'Carnival Pants',  slot: 'bottom',  value: 'carnivalpants',  price: 1.50, tier: 'premium' },
  { id: 'bot_explorerpants',  name: 'Explorer Pants',  slot: 'bottom',  value: 'explorerpants',  price: 1.50, tier: 'premium' },
  ...
  { id: 'hat_catears',     name: 'Cat Ears',         slot: 'hat',       value: 'catears',        price: 0.50, tier: 'basic' },
  ...
  { id: 'hat_safarihat',   name: 'Safari Hat',       slot: 'hat',       value: 'safarihat',      price: 0.50, tier: 'basic' },
  { id: 'hat_arenahelm',   name: 'Arena Helm',       slot: 'hat',       value: 'arenahelm',      price: 1.50, tier: 'premium' },
  // ── Accessories ───────────────────────────────────────────────────────────────
  // { id: 'acc_sword',       name: 'Sword',            slot: 'accessory', value: 'sword',          price: 1.50, tier: 'premium' },
  { id: 'acc_floatie',        name: 'Ostrich Floatie',    slot: 'accessory', value: 'ostirchfloatie',  price: 0.50, tier: 'basic' },
  ...
  { id: 'acc_cape',        name: 'Cape',             slot: 'accessory', value: 'cape',           price: 1.50, tier: 'premium' },
  { id: 'acc_embercloak',  name: 'Ember Cloak',      slot: 'accessory', value: 'embercloak',     price: 3.00, tier: 'rare' },
  { id: 'acc_wanderhood',  name: 'Wander Hood',      slot: 'accessory', value: 'wanderhood',     price: 0.50, tier: 'basic' },
  { id: 'acc_battlecloak', name: 'Battle Cloak',     slot: 'accessory', value: 'battlecloak',    price: 3.00, tier: 'rare' },
  { id: 'acc_arenaguard',  name: 'Arena Guard',      slot: 'accessory', value: 'arenaguard',     price: 1.50, tier: 'premium' },
  { id: 'acc_sandcloak',   name: 'Sand Cloak',       slot: 'accessory', value: 'sandcloak',      price: 1.50, tier: 'premium' },
  ...
  { id: 'color_neongreen', name: 'Neon Green',       slot: 'nameColor', value: '#39ff14',  price: 1.50, tier: 'rare'  },
  { id: 'color_neonpink',  name: 'Neon Pink',        slot: 'nameColor', value: '#ff2d78',  price: 1.50, tier: 'rare'  },
  { id: 'color_neonamber', name: 'Neon Amber',       slot: 'nameColor', value: '#ffaa00',  price: 1.50, tier: 'rare'  },
  ...
  // ── Name tag animations ───────────────────────────────────────────────────────
  { id: 'anim_bob',        name: 'Bob',              slot: 'nameAnim',  value: 'bob',      price: 1.50, tier: 'basic' },
  { id: 'anim_pulse',      name: 'Pulse',            slot: 'nameAnim',  value: 'pulse',    price: 1.50, tier: 'basic' },
  { id: 'anim_zoom',       name: 'Zoom',             slot: 'nameAnim',  value: 'zoom',     price: 1.50, tier: 'basic' },
  { id: 'anim_jitter',     name: 'Jitter',           slot: 'nameAnim',  value: 'jitter',   price: 1.50, tier: 'premium' },
  { id: 'anim_swing',      name: 'Swing',            slot: 'nameAnim',  value: 'swing',    price: 1.50, tier: 'premium' },
  ...
  { id: 'wall_marble',      name: 'Marble Wall',    slot: 'wallTheme',  value: 'marblewall',   price: 0.50, tier: 'basic'   },
  { id: 'wall_marbleblack', name: 'Black Marble Wall', slot: 'wallTheme', value: 'marblewallblack', price: 0.50, tier: 'basic' },
  ...
  { id: 'floor_marble',     name: 'Marble Floor',   slot: 'floorStyle', value: 'marble',       price: 0.50, tier: 'basic'   },
  { id: 'floor_marbleblack', name: 'Black Marble Floor', slot: 'floorStyle', value: 'marbleblack', price: 0.50, tier: 'basic' },
  { id: 'floor_carpetred',  name: 'Red Carpet',     slot: 'floorStyle', value: 'carpetred',    price: 0.50, tier: 'basic'   },
  { id: 'floor_carpetpurple', name: 'Purple Carpet', slot: 'floorStyle', value: 'carpetpurple', price: 0.50, tier: 'basic'   },
  { id: 'floor_carpetblue', name: 'Blue Carpet',    slot: 'floorStyle', value: 'carpetblue',   price: 0.50, tier: 'basic'   },
  { id: 'floor_carpetgold', name: 'Gold Carpet',    slot: 'floorStyle', value: 'carpetgold',   price: 1.50, tier: 'premium' },
  { id: 'floor_parquetwood', name: 'Parquet Wood',  slot: 'floorStyle', value: 'parquetwood',  price: 0.50, tier: 'basic'   },
