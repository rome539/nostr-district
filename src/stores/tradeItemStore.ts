...
export interface ItemSet {
  ...
  // Additional cosmetics granted by the same set (when one reward isn't enough).
  rewardCosmetics?: { slot: string; value: string; label: string }[];
}
...
export const ITEM_SETS: ItemSet[] = [
  ...
  },
  {
    ...
    rewardCosmetics: [{ slot: 'eyes', value: 'slit', label: 'Slit Eyes' }],
  },
  {
    id: 'set_eats',
    name: 'Greasy Spoon',
