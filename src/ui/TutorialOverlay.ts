...
interface Step {
  title: string;
  body: string;
  key?: string; // optional key hint to highlight
}
...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: 'Walk up to a building door and press <b>E</b> or <b>Space</b> to enter. You\'ll see a prompt appear when you\'re close enough.',
    key: 'E',
  },
  {
    title: 'Chat',
