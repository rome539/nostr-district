...
export const ITEM_DEFS: Record<string, ItemDef> = {
  ...
  beasthat:           { anchor: 'headTop', widthRatio: 1.4, roomWidthRatio: 1.2, above: true, yGap: -13, hubYGap: -6, noTint: true, naturalSize: true },
  safarihat:          { anchor: 'headTop', widthRatio: 1.4, roomWidthRatio: 1.2, above: true, yGap: -6, hubYGap: 1, naturalSize: true },
  arenahelm:          { anchor: 'headTop', widthRatio: 1.4, roomWidthRatio: 1.2, above: true, yGap: -13, hubYGap: -6, noTint: true, naturalSize: true },
...
export const itemImagesReady = Promise.all([
  ...
  loadItemImg('top_twotonelongsleeve_hub', 'assets/tops/twotonelongsleevehub.png'),
  loadItemImg('top_bannercoat_hub',        'assets/tops/bannercoathub.png'),
  ...
  loadItemImg('top_twotonelongsleeve_room', 'assets/tops/twotonelongsleeve.png'),
  loadItemImg('top_bannercoat_room',        'assets/tops/bannercoat.png'),
  ...
  loadItemImg('bottom_camoshorts_hub_2',  'assets/bottoms/camoshortshub.png'),
  loadItemImg('bottom_camoshorts_hub_3',  'assets/bottoms/camoshortshub.png'),
  loadItemImg('bottom_camoshorts_hub_4',  'assets/bottoms/camoshortshub.png'),
  loadItemImg('bottom_camoshorts_room_1', 'assets/bottoms/camoshorts.png'),
  loadItemImg('bottom_camoshorts_room_2', 'assets/bottoms/camoshorts.png'),
  loadItemImg('bottom_camoshorts_room_3', 'assets/bottoms/camoshorts.png'),
  loadItemImg('bottom_camoshorts_room_4', 'assets/bottoms/camoshorts.png'),
  loadItemImg('bottom_cargoshorts_hub_1',  'assets/bottoms/cargoshortshub.png'),
  loadItemImg('bottom_cargoshorts_hub_2',  'assets/bottoms/cargoshortshub.png'),
  loadItemImg('bottom_cargoshorts_hub_3',  'assets/bottoms/cargoshortshub.png'),
  loadItemImg('bottom_cargoshorts_hub_4',  'assets/bottoms/cargoshortshub.png'),
  loadItemImg('bottom_cargoshorts_room_1', 'assets/bottoms/cargoshorts.png'),
  loadItemImg('bottom_cargoshorts_room_2', 'assets/bottoms/cargoshorts.png'),
  loadItemImg('bottom_cargoshorts_room_3', 'assets/bottoms/cargoshorts.png'),
  loadItemImg('bottom_cargoshorts_room_4', 'assets/bottoms/cargoshorts.png'),
  ...
  loadItemImg('acc_embercloak_hub',       'assets/accessories/Embercloakhub.png'),
  loadItemImg('acc_embercloak_room',      'assets/accessories/Embercloak.png'),
  loadItemImg('acc_wanderhood_hub',       'assets/accessories/Wanderhoodhub.png'),
  loadItemImg('acc_wanderhood_room',      'assets/accessories/Wanderhood.png'),
  loadItemImg('acc_battlecloak_hub',      'assets/accessories/battlecloakhub.png'),
  loadItemImg('acc_battlecloak_room',     'assets/accessories/battlecloak.png'),
  loadItemImg('acc_arenaguard_hub',       'assets/accessories/ArenaGuardhub.png'),
  loadItemImg('acc_arenaguard_room',      'assets/accessories/ArenaGuard.png'),
  loadItemImg('acc_sandcloak_hub',        'assets/accessories/sandcloakhub.png'),
  loadItemImg('acc_sandcloak_room',       'assets/accessories/sandcloak.png'),
  ...
  loadItemImg('beasthat', 'assets/hats/beasthat.png'),
  loadItemImg('beasthat', 'assets/hats/beasthathub.png', hubImgCache),
  loadItemImg('safarihat', 'assets/hats/safarihat.png'),
  loadItemImg('safarihat', 'assets/hats/safarihathub.png', hubImgCache),
  loadItemImg('arenahelm', 'assets/hats/arenahelm.png'),
  loadItemImg('arenahelm', 'assets/hats/arenahelmhub.png', hubImgCache),
  ...
  loadItemImg('bottom_splitlinepants_hub_1', 'assets/bottoms/SplitlinePantshub1.png'),
  loadItemImg('bottom_splitlinepants_hub_2', 'assets/bottoms/SplitlinePantshub2.png'),
  loadItemImg('bottom_splitlinepants_hub_3', 'assets/bottoms/SplitlinePantshub3.png'),
  loadItemImg('bottom_splitlinepants_hub_4', 'assets/bottoms/SplitlinePantshub4.png'),
  loadItemImg('bottom_splitlinepants_room_1', 'assets/bottoms/SplitlinePants1.png'),
  loadItemImg('bottom_splitlinepants_room_2', 'assets/bottoms/SplitlinePants2.png'),
  loadItemImg('bottom_splitlinepants_room_3', 'assets/bottoms/SplitlinePants3.png'),
  loadItemImg('bottom_splitlinepants_room_4', 'assets/bottoms/SplitlinePants4.png'),
  loadItemImg('bottom_carnivalpants_hub_1', 'assets/bottoms/carnivalpantshub1.png'),
  loadItemImg('bottom_carnivalpants_hub_2', 'assets/bottoms/carnivalpantshub2.png'),
  loadItemImg('bottom_carnivalpants_hub_3', 'assets/bottoms/carnivalpantshub3.png'),
  loadItemImg('bottom_carnivalpants_hub_4', 'assets/bottoms/carnivalpantshub4.png'),
  loadItemImg('bottom_carnivalpants_room_1', 'assets/bottoms/carnivalpants1.png'),
  loadItemImg('bottom_carnivalpants_room_2', 'assets/bottoms/carnivalpants2.png'),
  loadItemImg('bottom_carnivalpants_room_3', 'assets/bottoms/carnivalpants3.png'),
  loadItemImg('bottom_carnivalpants_room_4', 'assets/bottoms/carnivalpants4.png'),
  loadItemImg('bottom_explorerpants_hub_1', 'assets/bottoms/explorerpantshub1.png'),
  loadItemImg('bottom_explorerpants_hub_2', 'assets/bottoms/explorerpantshub2.png'),
  loadItemImg('bottom_explorerpants_hub_3', 'assets/bottoms/explorerpantshub3.png'),
  loadItemImg('bottom_explorerpants_hub_4', 'assets/bottoms/explorerpantshub4.png'),
  loadItemImg('bottom_explorerpants_room_1', 'assets/bottoms/explorerpants1.png'),
  loadItemImg('bottom_explorerpants_room_2', 'assets/bottoms/explorerpants2.png'),
  loadItemImg('bottom_explorerpants_room_3', 'assets/bottoms/explorerpants3.png'),
  loadItemImg('bottom_explorerpants_room_4', 'assets/bottoms/explorerpants4.png'),
